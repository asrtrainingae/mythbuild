...
class HttpExceptions implements Exception {
  HttpExceptions.fromDioException(DioException dioException) {
    ...
    switch (dioException.type) {
      ...
      throw ConnectionError(dioException.requestOptions , "connection time out");
      case DioExceptionType.connectionError:
        throw ConnectionError(dioException.requestOptions , "connection_error");
...
class ConnectionError extends DioException {
  ConnectionError(RequestOptions r , String? message) : super(requestOptions: r , message:message);

  @override
  String toString() {
    return message ?? 'The connection ERROR';
  }
}
