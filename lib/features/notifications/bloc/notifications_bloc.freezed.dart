...
mixin _$NotificationsState {
  ...
  TResult when<TResult extends Object?>({
    ...
    required TResult Function(List<Noti> notifications) success,
  ...
  TResult? whenOrNull<TResult extends Object?>({
    ...
    TResult? Function(List<Noti> notifications)? success,
...
abstract class _$$SuccessImplCopyWith<$Res> {
  ...
  @useResult
  $Res call({List<Noti> notifications});
}
...
class _$SuccessImpl implements _Success {
  const _$SuccessImpl({required final List<Noti> notifications})
...
abstract class _Success implements NotificationsState {
  const factory _Success({required final List<Noti> notifications}) =
      _$SuccessImpl;
