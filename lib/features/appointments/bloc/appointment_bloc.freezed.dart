...
mixin _$AppointmentState {
  ...
  TResult when<TResult extends Object?>({
    ...
    required TResult Function(List<Appointment> canceledAppointments,
  ...
  TResult? whenOrNull<TResult extends Object?>({
    ...
    TResult? Function(List<Appointment> canceledAppointments,
            List<Appointment> appointments)?
        success,
...
abstract class _$$SuccessImplCopyWith<$Res> {
  ...
  @useResult
  $Res call(
      {List<Appointment> canceledAppointments, List<Appointment> appointments});
}
...
class _$SuccessImpl implements _Success {
  const _$SuccessImpl(
      {required final List<Appointment> canceledAppointments,
      required final List<Appointment> appointments})
      : _canceledAppointments = canceledAppointments,
        _appointments = appointments;

  final List<Appointment> _canceledAppointments;
  @override
  List<Appointment> get canceledAppointments {
  ...
  @override
  String toString() {
    return 'AppointmentState.success(canceledAppointments: $canceledAppointments, appointments: $appointments)';
  }
  ...
  TResult when<TResult extends Object?>({
    ...
    return success(canceledAppointments, appointments);
  }
  ...
  TResult? whenOrNull<TResult extends Object?>({
    ...
    return success?.call(canceledAppointments, appointments);
  }
...
abstract class _Success implements AppointmentState {
  const factory _Success(
      {required final List<Appointment> canceledAppointments,
      required final List<Appointment> appointments}) = _$SuccessImpl;
